...
class Solver():
    def __init__(self, cube, visualizer=None):
    ...
    def solveCube(self, debug=False, optimize=False):
        ...
        print(self.cube)
        if self.visualizer:
            self.visualizer.update(self.cube.cube, message="Scrambled Cube")
        ...
        try:
            ...
            self.__alignFaces()
            print("Alignment Moves: " + rawCondense("".join([f for f in self.__forms if f not in ["--align--", "--base--", "--first--", "--oll--", "--pll--"]])))
            print("Cube after Alignment:")
            print(self.cube)
            if self.visualizer and not self.visualizer.update(self.cube.cube, message="Step 1: Alignment Complete"): return
            ...
            self.__baseCross()
            print("Cross Moves: " + rawCondense("".join([f for f in self.__forms if f not in ["--align--", "--base--", "--first--", "--oll--", "--pll--"]])))
            print("Cube after Cross:")
            print(self.cube)
            if self.visualizer and not self.visualizer.update(self.cube.cube, message="Step 2: Cross Complete"): return
            pygame.time.wait(1000)

            # Step 3: Solve the First Two Layers (F2L)
            print("\nStep 3: Solving First Two Layers")
            self.__forms.append("--first--")
            self.__firstLayer()
            print("F2L Moves: " + rawCondense("".join([f for f in self.__forms if f not in ["--align--", "--base--", "--first--", "--oll--", "--pll--"]])))
            print("Cube after F2L:")
            print(self.cube)
            if self.visualizer and not self.visualizer.update(self.cube.cube, message="Step 3: F2L Complete"): return
            pygame.time.wait(1000)

            # Step 4: Orient Last Layer (OLL)
            print("\nStep 4: Orienting Last Layer (OLL)")
            self.__forms.append("--oll--")
            self.__oll()
            print("OLL Moves: " + rawCondense("".join([f for f in self.__forms if f not in ["--align--", "--base--", "--first--", "--oll--", "--pll--"]])))
            print("Cube after OLL:")
            print(self.cube)
            if self.visualizer and not self.visualizer.update(self.cube.cube, message="Step 4: OLL Complete"): return
            pygame.time.wait(1000)

            # Step 5: Permute Last Layer (PLL)
            print("\nStep 5: Permuting Last Layer (PLL)")
            self.__forms.append("--pll--")
            self.__pll()
            print("PLL Moves: " + rawCondense("".join([f for f in self.__forms if f not in ["--align--", "--base--", "--first--", "--oll--", "--pll--"]])))
            
            # Final State
            print("\nFinal Solved Cube:")
            print(self.cube)
            if self.visualizer and not self.visualizer.update(self.cube.cube, message="Cube is Solved!"): return
            pygame.time.wait(2000)
    ...
    def __checkComplete(self):
        ...
        if(not isDone):
            ...
            print("Please try again with a different scramble or check the cube's state.")
    ...
    def __alignFaces(self):
        ...
        # This implementation is more robust and less prone to IndexErrors
        if(self.__faces[0][1][1] != "G"):
        ...
        if(self.__faces[5][1][1] != "Y"):
            if(self.__faces[0][1][1] == "Y"):
                self.__move("x'")
            elif(self.__faces[1][1][1] == "Y"):
                self.__move("z'")
            elif(self.__faces[2][1][1] == "Y"):
                self.__move("x")
